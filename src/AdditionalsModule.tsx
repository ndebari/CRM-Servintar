  ...
  return <>
    ...
    <section className="panel">
      ...
      <form onSubmit={save}>
        ...
        <p className="muted-copy">El valor se ingresa en cada cotización. El % se aplica al transporte base (kilómetros + días), antes de peajes, adicionales y utilidad.</p>
